  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "neon-flicker": {
          "0%, 100%": {
            textShadow: "0 0 10px hsl(187 100% 50% / 0.8), 0 0 20px hsl(187 100% 50% / 0.6)"
          },
          "50%": {
            textShadow: "0 0 20px hsl(187 100% 50% / 1), 0 0 40px hsl(187 100% 50% / 0.8), 0 0 60px hsl(187 100% 50% / 0.6)"
          }
        }
      },
      animation: {
